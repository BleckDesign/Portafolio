...
function startwin(id){
    if(id < 500){
        ...
        if (id == 014){
            showimg.src = "img/diseno/14-ec/14-ec.png";
            player.style.display = "flex";
            showimg.onload = function(){
                if(playerstat == 0) {
                    playerstat = 1;
        ...
        if (id == 015){
            showimg.src = "img/diseno/ESL/ESL-2.png";
            player.style.display = "flex";
            showimg.onload = function(){
                if(playerstat == 0) {
                    playerstat = 1;
        ...
        if (id == 016){
            showimg.src = "img/diseno/encuesta/encuesta.png";
            player.style.display = "flex";
            showimg.onload = function(){
                if(playerstat == 0) {
                    playerstat = 1;
        ...
        if (id == 017){
            showimg.src = "img/diseno/fernanda/fernanda.jpg";
            player.style.display = "flex";
            showimg.onload = function(){
                if(playerstat == 0) {
                    playerstat = 1;
        ...
        if (id == 018){
            showimg.src = "img/diseno/gracias/gracias.jpg";
            player.style.display = "flex";
            showimg.onload = function(){
                if(playerstat == 0) {
                    playerstat = 1;
        ...
        if (id == 019){
            showimg.src = "img/diseno/programas/programas.jpg";
            player.style.display = "flex";
            showimg.onload = function(){
                if(playerstat == 0) {
                    playerstat = 1;
        ...
        if (id == 020){
            showimg.src = "img/diseno/portadas/1.jpg";
            player.style.display = "flex";
            showimg.onload = function(){
                if(playerstat == 0) {
                    playerstat = 1;
    ...
    if(id > 500){
        ...
        if (id == 512){
            showvid.src = "img/videos/filtrosusana/filtro.mp4";
            player.style.display = "flex";
        }
        if (id == 513){
            showvid.src = "img/videos/eclipse-ec/eclipse-ec.mp4";
            player.style.display = "flex";
        }
        if (id == 514){
            showvid.src = "img/videos/animacion-dg/animacion_dg.mp4";
            player.style.display = "flex";
        }
        if (id == 515){
            showvid.src = "img/videos/vacaciones/vacaciones.mp4";
            player.style.display = "flex";
        }
        if (id == 516){
            showvid.src = "img/videos/rigo/rigo.mp4";
            player.style.display = "flex";
        }
        if (id == 517){
            showvid.src = "img/videos/lili/lili.mp4";
            player.style.display = "flex";
        }
...
arrowup.addEventListener('click', function(){
    ...
    if(reelstat == 54){
        reelstat = 53;
        showimg.src = "img/diseno/portadas/4.png";
    }
    if(reelstat == 53){
        reelstat = 52;
        showimg.src = "img/diseno/portadas/3.jpg";
    }
    if(reelstat == 52){
        reelstat = 51;
        showimg.src = "img/diseno/portadas/2.jpg";
    }
    if(reelstat == 51){
        reelstat = 50;
        showimg.src = "img/diseno/portadas/1.jpg";
...
arrowdown.addEventListener('click', function(){
    if(reelstat == 53){
        reelstat = 54;
        showimg.src = "img/diseno/portadas/5.png";
    }
    if(reelstat == 52){
        reelstat = 53;
        showimg.src = "img/diseno/portadas/4.png";
    ...
    if(reelstat == 40){
        reelstat = 41;
        showimg.src = "img/diseno/ESL/ESL-3.jpg";
    }
    if(reelstat == 30){
        reelstat = 31;
